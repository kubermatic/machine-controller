...
func (p *Provider) Validate(spec clusterv1alpha1.MachineSpec) error {
	...
	switch cfg.providerConfig.Network.GetAddressFamily() {
	...
	default:
		return newError(common.InvalidConfigurationMachineError, util.ErrUnknownNetworkFamily, cfg.providerConfig.Network.GetAddressFamily())
	}
