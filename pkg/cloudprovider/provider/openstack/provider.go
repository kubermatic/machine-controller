...
type Validation interface {
	ValidateApplicationCredentials(machinespec clusterv1alpha1.MachineSpec, externalCloudProvider bool) error
}
...
func (p *provider) ValidateApplicationCredentials(spec clusterv1alpha1.MachineSpec, externalCloudProvider bool) error {
