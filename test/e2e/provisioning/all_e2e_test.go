...
func TestKubevirtProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"sles", "flatcar"}}
	params := []string{
...
func TestOpenstackProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"sles", "rhel", "flatcar"}}
...
func TestAWSSLESProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"coreos", "ubuntu", "centos", "rhel", "flatcar"}}
	runScenarios(t, excludeSelector, params, AWSManifest, fmt.Sprintf("aws-%s", *testRunIdentifier))
}
...
func TestGCEProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"centos", "sles", "rhel", "flatcar"}}
	params := []string{
...
func TestHetznerProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"coreos", "sles", "rhel", "flatcar"}}
...
func TestAlibabaProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"coreos", "rhel", "sles", "flatcar"}}
...
func TestLinodeProvisioningE2E(t *testing.T) {
	...
	excludeSelector := &scenarioSelector{osName: []string{"coreos", "centos", "sles", "rhel", "flatcar"}}
