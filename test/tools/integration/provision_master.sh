...
rsync -avR  -e "ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no" \
    ../../.././{Makefile,examples/machine-controller.yaml,machine-controller,machine-controller-userdata-centos,machine-controller-userdata-coreos,machine-controller-userdata-ubuntu,machine-controller-userdata-sles,Dockerfile,webhook} \
    root@$ADDR:/root/
fi
