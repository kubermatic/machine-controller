...
if [[ ! -z "${NUTANIX_E2E_PROXY_HOST:-}" ]]; then
  ...
  ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -fNT -R ${LC_PRIV_ADDR}:${NUTANIX_E2E_PROXY_PORT}:10.240.20.100:${NUTANIX_E2E_PROXY_PORT} root@${LC_ADDR}
fi
